# Create Wanaku Capabilities Java SDK Issue

Create a new issue in the Wanaku Capabilities Java SDK GitHub repository.

## Usage

```
/wanaku-capabilities-java-sdk-create-issue <title>
```
...
```bash
gh issue create --repo wanaku-ai/wanaku-capabilities-java-sdk --title "<TITLE>" --label "<LABELS>" --body "$(cat <<'EOF'
<BODY_CONTENT>
EOF
)"
```
...
Issue #123: https://github.com/wanaku-ai/wanaku-capabilities-java-sdk/issues/123
```
...
- Issue is created in the Wanaku Capabilities Java SDK repository
